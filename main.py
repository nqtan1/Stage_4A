...
fre1 = np.array([4.3189,26.7983,73.6718,145.2921,244.3988,365.7557,509.0039,683.4146])
...
init_PSO = PSO()
defauts, pop, fit = init_PSO.enable_PSO(fre2,10)
